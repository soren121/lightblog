...
$result11 = sqlite_query($handle, "SELECT * FROM posts WHERE id=".$_GET['id']."") or die("SQLite query error: code 02<br>".sqlite_error_string(sqlite_last_error($handle)));
...
<div id="container">
	...
	<div id="content">
	 ...
	 if(isset($_POST['publish'])) {
	 	...
	 	sqlite_query($handle, "UPDATE posts SET title='".$title."' WHERE id='".$id."'") or die("SQLite query error: code 02<br>".sqlite_error_string(sqlite_last_error($handle)));
	 	sqlite_query($handle, "UPDATE posts SET post='".$text."' WHERE id='".$id."'") or die("SQLite query error: code 02<br>".sqlite_error_string(sqlite_last_error($handle)));
